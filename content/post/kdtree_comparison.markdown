...
```
## Time difference of 3.41148 secs
```
...
This only took 3.411 seconds! A 98.3% increase in speed! And there was no loss in accuracy. The speed benefits would only grow as the data grows more complex and larger. 
